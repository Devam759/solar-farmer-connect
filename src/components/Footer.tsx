        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#schemes" className="text-lg text-green-100 hover:text-white transition-colors flex items-center group">
                  <FileText className="w-5 h-5 mr-3 group-hover:text-secondary-light transition-colors" />
                  <span className="border-b border-transparent group-hover:border-secondary-light transition-all">Scheme Guidelines</span>
                </a>
              </li>
              <li>
                <a href="#implementation" className="text-lg text-green-100 hover:text-white transition-colors flex items-center group">
                  <FileText className="w-5 h-5 mr-3 group-hover:text-secondary-light transition-colors" />
                  <span className="border-b border-transparent group-hover:border-secondary-light transition-all">Implementation Process</span>
                </a>
              </li>
              <li>
                <a href="#impact" className="text-lg text-green-100 hover:text-white transition-colors flex items-center group">
                  <Info className="w-5 h-5 mr-3 group-hover:text-secondary-light transition-colors" />
                  <span className="border-b border-transparent group-hover:border-secondary-light transition-all">Impact Assessment</span>
                </a>
              </li>
              <li>
                <a href="#" className="text-lg text-green-100 hover:text-white transition-colors flex items-center group">
                  <FileText className="w-5 h-5 mr-3 group-hover:text-secondary-light transition-colors" />
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start text-lg text-green-100">
              ...
              <li className="flex items-center text-lg text-green-100">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-lg text-green-100 hover:text-white transition-colors block pb-1 border-b border-transparent hover:border-secondary-light">
                  PM-KUSUM Scheme
                </a>
              </li>
              <li>
        ...
        <div className="mt-16 pt-8 border-t border-green-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-10 mt-6 md:mt-0">
              <a href="#" className="text-base text-green-100 hover:text-white transition-colors border-b border-transparent hover:border-secondary-light">
                RTI
              </a>
              <a href="#" className="text-base text-green-100 hover:text-white transition-colors border-b border-transparent hover:border-secondary-light">
                Terms of Use

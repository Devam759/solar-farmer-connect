...
const FutureScope = () => {
  const futureInnovations = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1569691105751-88df003de7a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1622030303288-95241252c0f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    ...
    <section id="future-scope" className="section-spacing bg-solar-50">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto animate-fade-in">
          ...
          <h2 className="section-title">Future Scope & Innovations</h2>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {futureInnovations.map((innovation, index) => (
            ...
            >
              ...
              <div className="p-6">
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium mb-3 ${innovation.color}`}>
                  Coming Soon
                </div>
        ...
        <div className="mt-16 glass-card p-8 animate-fade-in">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="md:w-1/2">
              <h3 className="text-2xl font-semibold mb-6">Policy Developments</h3>
              ...
              <div className="space-y-6">
                {policyDevelopments.map((policy, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-lg mb-1">{policy.title}</h4>
            ...
            <div className="md:w-1/2">
              <h3 className="text-2xl font-semibold mb-6">Expansion Targets</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="relative pt-1">
                  ...
                  <div className="flex h-2 mb-4 overflow-hidden rounded bg-primary/10">
                    <div style={{ width: "40%" }} className="flex flex-col justify-center rounded bg-primary shadow-none animate-pulse-slow"></div>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Reach 1 million farmer installations by 2026 (currently at 250,000+)
                  </p>
                </div>
                ...
                <div className="relative pt-1">
                  ...
                  <div className="flex h-2 mb-4 overflow-hidden rounded bg-primary/10">
                    <div style={{ width: "25%" }} className="flex flex-col justify-center rounded bg-primary shadow-none animate-pulse-slow"></div>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Increase installed capacity to 5GW by 2025 (currently at 1.5GW)
                  </p>
                </div>
              </div>
              
              <div className="mt-8 p-6 bg-white/50 rounded-xl">
                <h4 className="font-medium text-lg mb-3">Research Priorities</h4>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <span>Improved efficiency solar panels for varied climates</span>
                  </li>
                  <li className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-primary mr-2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                    </svg>
                    <span>Cost-effective storage technologies for 24/7 operations</span>
                  </li>
                  <li className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-primary mr-2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                    </svg>
                    <span>Dual-use technologies for agrivoltaics applications</span>
                  </li>
                </ul>
              </div>
            </div>
